    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header">
                <div class="pull-left">
                    <h2 class="card-title"><i class="material-icons">settings</i> ภาพสไลลด์</h2>
                </div>
                <div class="pull-right">
                    <a class="btn btn-darken" href="{{ route('slide.create') }}" title="เพิ่ม ภาพสไลลด์"> <i
                            class="material-icons">add</i> เพิ่ม ภาพสไลลด์
                    </a>
                </div>
            </div>
            <div class="card-body">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="qns-img text-center">
                                        <img src="{{ asset('slides/'.$row->image_name) }}" style="width: 200px;">
                                    </div>
                                </td>
                                <td class="text-right ">
                                    <a class="btn-icon btn-darken" href="{{ route('slide.edit', $row->id) }}"
                                        title="Edit">
                                        <i class="material-icons">edit</i>
                                    </a>

                                    <a class="deletebtn btn-icon btn-darken"
                                        data-action="{{ route('slide.destroy', $row->id) }}" href="#" title="Delete">
