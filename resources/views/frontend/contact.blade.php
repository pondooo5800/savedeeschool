...
<div class="container-fluid py-5">
    <div class="">
        ...
        <div class="contact-detail position-relative p-3">
            ...
            <div class="row">
                <div class="col-lg-6 wow fadeIn my-2" data-wow-delay=".2s">
                ...
                <div class="col-lg-6 wow fadeIn my-2" data-wow-delay=".2s">
                    <div class="p-4 rounded contact-form">
                        <form action="{{ url('send-line-notification') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="mb-4">
                                <input type="text" required name="name" class="form-control border-0 py-2"
                                    placeholder="ชื่อ-สกุล">
                            </div>
                            <div class="mb-4">
                                <input type="text" required name="phone" class="form-control border-0 py-2"
                            ...
                            <div class="mb-4">
                                <select required class="form-select border-0 py-2" aria-label="Default select example"
                                    name="course">
